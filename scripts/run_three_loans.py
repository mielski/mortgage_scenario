...
rates += rates_addon
loan1 = LoanPartIterator(92500, rates[0], years, future=92500, yearly=True)
loan2 = LoanPartIterator(198183, rates[1], years, yearly=True)
loan3 = LoanPartIterator(144000, rates[2], years, yearly=True)
